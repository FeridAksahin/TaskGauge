...
namespace TaskGauge.Entity.Migrations
{
    ...
    [Migration("20240225134602_added totalEffort")]
    partial class addedtotalEffort
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskGauge.Entity.Entity.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TaskGauge.Entity.Entity.SecurityQuestion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TaskGauge.Entity.Entity.User", b =>
                {
                    b.HasOne("TaskGauge.Entity.Entity.Role", "Role")
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TaskGauge.Entity.Entity.SecurityQuestion", "SecurityQuestion")
                        .WithMany()
